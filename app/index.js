...
const WelcomeScreen = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Image source={require('../assets/images/welcome-app.jpg')}
        ...
        {/*  Linear Gradient*/}
            <Animated.View entering={FadeInDown.duration(600)} style={{flex:1}}>
                ...
                <View style={styles.contentContainer}>
                    ...
                    <Animated.Text entering={FadeInDown.delay(500).springify()} style={styles.description}>
                        Every Show tells a story
                    </Animated.Text>
                    <Animated.View entering={FadeInDown.delay(600).springify()}>
                        <Pressable onPress={() => router.push('home')} style={styles.startButton}>
                            <Text style={styles.startText}>Start Expolre</Text>
                        </Pressable>
                    </Animated.View>
                </View>
